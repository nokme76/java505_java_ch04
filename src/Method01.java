...
//            연산의 결과가 입력되는 데이터에 따라 변경됨
    ...
    double dResult = divType4(150,50);
...
//    return 키워드 사용 시 반환되는 값의 데이터 타입은 해당 메서드의 반환 타입과 일치 해야함
